...
class BitBucket:
  ...
  def StoreBits22(self, val):
    """
    Stores the 22 least-significant bits from val in network order (big endian)
    """
    tmp_val = struct.pack(">I", val)
    self.StoreBits ( (StrToList(tmp_val), 22))
